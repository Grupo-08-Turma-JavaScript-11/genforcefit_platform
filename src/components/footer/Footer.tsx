...
>>>>>>> 5f14cdd4523ca2cf17156456fbd923c20d298f94
          <Link to="https://www.whatsapp.com"
            ...
            <img className="cursor-pointer transition duration-300 hover:drop-shadow-[0_0_8px_var(--green-neon)] hover:-translate-y-[3px]"
        ...
        <nav className="footer-nav">
          <h3 className='text-[var(--green-soft)] mb-5 text-[1.2rem]'>Links Rápidos</h3>
          <ul>
            <li className='mb-3'>
                <a href="#sobrenos"
        ...
        <div className="newsletter">
          <h3 className='text-[var(--green-soft)] text-[1.1rem]'>Conecte-se às novidades</h3>
